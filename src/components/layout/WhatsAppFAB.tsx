...
export function WhatsAppFAB() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 top-1/2 -translate-y-1/2 bg-[var(--bg-primary)] text-[var(--text-primary)] text-[13px] font-medium px-3 py-1.5 rounded-lg shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity">
        Chat with us!
      </span>
    </a>
  );
