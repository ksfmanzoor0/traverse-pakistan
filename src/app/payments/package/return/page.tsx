    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center space-y-5">
          ...
          <a
            href={getWhatsAppUrl(`Hi, I made a payment for package booking ${bookingRef} and it's being processed. Can you confirm my booking?`)}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex h-11 px-6 items-center rounded-[var(--radius-sm)] bg-[var(--primary)] text-[var(--text-inverse)] text-[14px] font-semibold hover:bg-[var(--primary-hover)] transition-colors"
          >
      ...
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center space-y-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              href={getWhatsAppUrl(`Hi, I tried to pay for package booking ${bookingRef} but the payment didn't go through. Can you help?`)}
              target="_blank"
              rel="noopener noreferrer"
